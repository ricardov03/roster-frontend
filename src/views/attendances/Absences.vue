...
import {CheckCircleIcon,ChevronLeftIcon,XCircleIcon} from '@heroicons/vue/20/solid'
                ...
                <table class="min-w-full divide-y divide-gray-300">
                  ...
                  <tr v-for="student in section.roster" :key="student.student_id">
                    ...
                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500 flex justify-center">
                      <XCircleIcon v-if="absent(student.student_id)" class="h-8 w-8 text-red-500" />
                      <CheckCircleIcon v-else class="h-8 w-8 text-green-500" />
                    </td>
                  </tr>
                  </tbody>
                </table>
